    ...
    public partial class Chofer : Form
    {
        ...
        private void txtBusqueda_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                sql_con.Open();
                sql_cmd = sql_con.CreateCommand();
                string CommandText = "select count(CODIGO) As Viajes_totales, sum(Valor_viaje) As Total_recaudado, Fecha, Chofer from viajes where Chofer like ('" + txtBusqueda.Text + "%')";
